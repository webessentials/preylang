...
/**
 * Class GroupAdminResponseStatusCodeTest
 * @package Tests\Feature
 * @group groupAdminResponseStatusCodeTest
 */
class GroupAdminResponseStatusCodeTest extends TestCase
{
    /** @var User $user */
    protected $user;
    ...
    protected function setUp()
    {
        ...
        $this->user = factory(User::class)->create([
            'role' => config('settings.user_roles.1'),
     ...
     * @return void
     */
    public function testUserRouteForAdmin()
    {
        /* @var User $testUser */
        ...
        foreach ($adminRouteTests as $test) {
            echo "\n" . $test['route'];
     ...
     * @return void
     */
    public function testSettingsRouteForAdmin()
    {
     ...
     * @return void
     */
    public function testImpactRouteForAdmin()
    {
     ...
     * @return void
     */
    public function testRawImpactRouteForAdmin()
    {
        $testVillager = factory(Villager::class)->create([
            'user_group_id' => $this->testUserGroup->id
        ]);
     ...
     * @return void
     */
    public function testVillagerRouteForAdmin()
    {
        $testVillager = factory(Villager::class)->create([
            'user_group_id' => $this->testUserGroup->id
        ]);
     ...
     * @return void
     */
    public function testFilesForAdmin()
    {
        $this->be($this->user);
        $adminRouteTests = [
