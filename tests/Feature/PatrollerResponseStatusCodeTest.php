...
/**
 * Class PatrollerResponseStatusCodeTest
 * @package Tests\Feature
 * @group patrollerResponseStatusCodeTest
 */
class PatrollerResponseStatusCodeTest extends TestCase
{
    /** @var User $user */
    protected $user;
     ...
     * @return void
     */
    public function testUserRouteForPatroller()
    {
        /* @var User $testUser */
        ...
        foreach ($patrollerRouteTests as $test) {
            echo "\n" . $test['route'];
     ...
     * @return void
     */
    public function testSettingsRouteForPatroller()
    {
     ...
     * @return void
     */
    public function testImpactRouteForPatroller()
    {
        ...
        $this->be($this->user);
        $patrollerRouteTests = [
            ['route' => '/impact/', 'expect' => 401],
            ['route' => '/impact/edit/' . $testImpact->id, 'expect' => 401],
            ['route' => '/impact/show/' . $testImpact->id, 'expect' => 401],
            ...
            ['route' => '/impact/filter', 'expect' => 401],
            ['route' => '/impact/subcategories/0/1', 'expect' => 401],
            ['route' => '/activity/', 'expect' => 401]
        ];
        foreach ($patrollerRouteTests as $test) {
            echo "\n" . $test['route'];
            $response = $this->get($test['route']);
     ...
     * @return void
     */
    public function testRawImpactRouteForPatroller()
    {
        $testVillager = factory(Villager::class)->create([
            'user_group_id' => $this->testUserGroup->id
        ]);
        ...
        $this->be($this->user);
        $patrollerRouteTests = [
            ['route' => '/rawimpact', 'expect' => 401],
            ['route' => '/rawimpact/show/' . $testRawImpact->id, 'expect' => 401],
     ...
     * @return void
     */
    public function testVillagerRouteForPatroller()
    {
        $testVillager = factory(Villager::class)->create([
            'user_group_id' => $this->testUserGroup->id
        ]);
     ...
     * @return void
     */
    public function testFilesForPatroller()
    {
        $this->be($this->user);
        $patrollerRouteTests = [
