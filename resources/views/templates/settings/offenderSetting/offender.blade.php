...
@section('content')
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="btn btn-primary btn-mini" title="{{ Lang::get('preylang.new') }}" href="{{ route('offender.create') }}">+</a>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!$offender->read_only)
                                                <a class="btn green" title="{{ Lang::get('preylang.edit') }}" href="{{ route('offender.edit', $offender->id) }}">
                                            ...
                                            @if($offender->offenderImpacts->count() === 0)
                                                <a href="#" class="btn green" title="{{ Lang::get('preylang.delete') }}" data-toggle="modal" data-target="#deleteUserModal-{{ $offender->id }}">
    ...
    @foreach($offenders as $offender)
        @if($offender->offenderImpacts->count() === 0)
            @include('partials.modal', ['show'=>$offender, 'id'=>'deleteUser', 'path'=>'offender.delete'])
        @endif
    @endforeach
@endsection
